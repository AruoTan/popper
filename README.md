...
当前版本为 **0.4.0**，版本记录从 0.3.56 直接进入 0.4.0。
...
![结果窗口](./assets/screenshots/result.png)

### 设置 · 工具栏动作

![设置-工具栏动作](./assets/screenshots/settings-toolbar-actions.png)

### 设置 · AI 服务商与模型

![设置-AI服务商与模型](./assets/screenshots/settings-ai-providers.png)
